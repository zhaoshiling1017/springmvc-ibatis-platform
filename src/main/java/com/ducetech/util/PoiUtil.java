...
public class PoiUtil {
	 ...
	 * */
	//宋体加粗22号字 居中
	public HSSFCellStyle songBoldFont22(HSSFWorkbook wb) {
		HSSFFont curFont = wb.createFont(); // 设置字体
		curFont.setFontName("宋体");
		curFont.setCharSet(HSSFFont.DEFAULT_CHARSET); // 设置中文字体，那必须还要再对单元格进行编码设置
		curFont.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD); // 加粗
		curFont.setFontHeightInPoints((short) 22);
		
		HSSFCellStyle curStyle = wb.createCellStyle();
		curStyle.setFont(curFont);
		curStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER); // 单元格垂直居中
		curStyle.setAlignment(HSSFCellStyle.ALIGN_CENTER); 				// 单元格水平居中

		return curStyle;
	}
	
	//宋体加粗18号字 左对齐
	public HSSFCellStyle songBoldFont18(HSSFWorkbook wb) {
		HSSFFont curFont = wb.createFont(); 							// 设置字体
		curFont.setFontName("宋体");
		curFont.setCharSet(HSSFFont.DEFAULT_CHARSET); 					// 设置中文字体，那必须还要再对单元格进行编码设置
		curFont.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD); 				// 加粗
		...
		curStyle.setFont(curFont);
		curStyle.setVerticalAlignment(HSSFCellStyle.VERTICAL_CENTER); 	// 单元格垂直居中
		curStyle.setAlignment(HSSFCellStyle.ALIGN_LEFT); 				// 单元格水平左对齐

		return curStyle;
	}
	
	//宋体加粗9号字 居中
	public HSSFCellStyle songBoldFont9(HSSFWorkbook wb) {
		HSSFFont curFont = wb.createFont(); // 设置字体
		curFont.setFontName("宋体");
		curFont.setCharSet(HSSFFont.DEFAULT_CHARSET); // 设置中文字体，那必须还要再对单元格进行编码设置
		curFont.setBoldweight(HSSFFont.BOLDWEIGHT_BOLD); // 加粗
	...
	//宋体9号字 居中 可换行
	public HSSFCellStyle songFont9(HSSFWorkbook wb) {
		HSSFFont curFont = wb.createFont(); // 设置字体
		curFont.setFontName("宋体");
		curFont.setCharSet(HSSFFont.DEFAULT_CHARSET); // 设置中文字体，那必须还要再对单元格进行编码设置
		curFont.setFontHeightInPoints((short) 9);
	...
	//宋体9号字 居中
	public HSSFCellStyle songFont9colwidth5(HSSFWorkbook wb) {
		HSSFFont curFont = wb.createFont(); // 设置字体
		curFont.setFontName("宋体");
		curFont.setCharSet(HSSFFont.DEFAULT_CHARSET); // 设置中文字体，那必须还要再对单元格进行编码设置
		curFont.setFontHeightInPoints((short) 9);
